...
add_files -fileset [get_filesets constrs_1] ${script_dir}/src/constraints/zcu104_system_constr.xdc
################################################################################
# Synthesis config
################################################################################
...
if { $run_step == "bitstream" } {
  ...
  write_hw_platform -fixed -force -file ${script_dir}/vivado_prj/system_top.xsa
}
